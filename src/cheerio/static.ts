...
import type { CheerioAPI, Cheerio } from './index.ts';
import { Node, Document, isText, hasChildren } from '../domhandler/index.ts';
import {
  InternalOptions,
  CheerioOptions,
...
import { ElementType } from '../htmlparser2/index.ts';
